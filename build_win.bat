...
@REM 
@set WEBGPU_BACKEND_STR="WEBGPU_WGPU_NATIVE"
@REM @set WEBGPU_BACKEND_STR="WEBGPU_DAWN"
...
@set CMAKE_GEN_BUILD_FILE_CMD=cmake -S . -B .\build -DCMAKE_BUILD_TYPE=Release -DCMAKE_PREFIX_PATH=%MY_CMAKE_PREFIX_PATH% -DWEBGPU_BACKEND_STR=%WEBGPU_BACKEND_STR% -DWEBGPU_WGPU_NATIVE_BASE_DIR=%MY_WEBGPU_WGPU_NATIVE_BASE_DIR%
