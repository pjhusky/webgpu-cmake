...
bool Application::Initialize() {
...
#else	
	deviceDesc.defaultQueue.label = WGPUStringView{ "The default queue", strlen( "The default queue" ) };
	...
	surfaceFormat = WGPUTextureFormat_BGRA8Unorm; WGPUTextureFormat_RGBA8Uint;
